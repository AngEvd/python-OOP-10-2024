...
print(f"{student.name} has enrolled {student.courses}")
student.enroll("Math", ["1 + 1 = 2"])
print(f"{student.name} has enrolled {student.courses}")
student.enroll("Math 2", ["1 + 2 = 3"], "Y")
print(f"{student.name} has enrolled {student.courses}")
student.enroll("Math 3", ["1 + 2 = 3"], "wtf")
print(f"{student.name} has enrolled {student.courses}")
# student.add_notes("Math", "wtf?",)
# print(f"{student.name} has enrolled {student.courses}")
